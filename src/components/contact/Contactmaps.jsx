...
function Contactmaps() {
  ...
  return (
    <div className="w-full bg-gray-50 py-16 px-4 lg:px-25" data-aos="zoom-in">
          ...
          <form className="space-y-8 flex flex-col w-full">
            <div className="flex flex-col sm:flex-row gap-6 w-full">
              <input
                ...
                required
                autoComplete="name"
                className="w-full sm:w-1/2 px-4 py-3 border border-gray-300 rounded-lg transition focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:shadow-md focus:shadow-teal-300 focus:outline-none"
              />
            ...
            <input
              type="text"
              placeholder="Subject"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-teal-500 focus:shadow-md focus:shadow-teal-300 focus:outline-none"
            />
            ...
            <button
              type="submit"
              className="bg-teal-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-teal-700 transition-all duration-300"
            >
              Send Message
            </button>
          </form>
