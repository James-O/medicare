...
function Contacth() {
  ...
  return (
    <div className='py-10 pt-26 bg-white left-0 right-0'>
      <div className='left-0 right-0 py-4 bg-gray-100 lg:px-28' >
       <div className='flex justify-between items-center'>
        <div><h1 className='text-blue-950'>Contact</h1></div>
        <ul className='flex gap-2'><li className='text-teal-600'><a href='/'>Home</a></li><li>/ <a href='/about'>Contact</a></li></ul>
       </div>
      </div>
      <div className='flex justify-center items-center text-center py-20 flex-col lg:px-28 flex-1 px-4' data-aos="zoom-in">
        <h1 className='text-4xl font-semibold mb-2 text-blue-950'>Contact</h1>
