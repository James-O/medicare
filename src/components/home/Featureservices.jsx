...
import { ArrowRight, Bone, Brain, Divide, FlaskConical, PersonStanding, Ribbon, RibbonIcon } from 'lucide-react';
import AOS from "aos";
            ...
            <div className="py-12 px-6 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:px-14">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:-translate-y-2 hover:shadow-lg">
                        ...
                        <div className="p-6 border-t-black hover:scale-105">
                            ...
                            <div className="flex">
                                <a
                                    href="#"
                                    className="group flex items-center text-teal-600 font-semibold mt-4 transition-all duration-300 hover:tracking-wide hover:scale-105"
                                >
